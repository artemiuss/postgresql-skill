...
- `references/` - Detailed reference documentation (39 files)
- `scripts/` - Executable SQL migration scripts
- `tests/` - Comprehensive PL/pgSQL test suite (11 modules)
- `README.md` - Repository overview, sources, and attribution
- `THIRD_PARTY_NOTICES.md` - Imported third-party file provenance

**Installation:** Users copy this entire directory to `.claude/skills/postgresql-skill/` (project) or `~/.claude/skills/postgresql-skill/` (personal).
...
- `process-architecture.md` - Multi-process model and connection scaling
- `memory-management-ops.md` - `work_mem`, shared buffers, and OOM risk
- `mvcc-transactions.md` - Isolation levels, wraparound, long transactions
- `wal-operations.md` - WAL, checkpoints, durability, crash recovery
- `storage-layout.md` - PGDATA, TOAST, fillfactor, tablespaces
